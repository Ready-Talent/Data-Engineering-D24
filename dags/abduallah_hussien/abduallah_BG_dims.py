...
table_list = ['dim_product','dim_customer','junk_dim','dim_date','fact_sales']
table_list_sql = ['dim_product.sql','dim_customer.sql','junk_dim.sql','dim_date.sql','fact_sales.sql']
